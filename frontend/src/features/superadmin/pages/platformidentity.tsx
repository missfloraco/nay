...
import { Layout, Save, ImageIcon, Globe, Palette, Type, Link, FileType, Info, ShieldCheck, Fingerprint } from 'lucide-react';
...
export default function PlatformIdentity() {
    ...
    }, [saving, formData, logoFiles, removeLogo, removeFavicon, removeCustomFont, removeCustomHeadingFont]);
    ...
    return (
        <AdminLayout title="هوية المنصة" icon={Layout}>
            <div className="grid lg:grid-cols-2 gap-8 items-start animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                {/* Right Column: Typography & Customization */}
                <div className="space-y-8">
                    {/* Typography Card */}
                    <div className="bg-white dark:bg-dark-900 rounded-[2.5rem] border border-gray-100 dark:border-dark-800 shadow-premium overflow-hidden">
