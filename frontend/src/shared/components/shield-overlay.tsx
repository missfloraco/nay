...
export default function ShieldOverlay() {
    ...
    return (
        ...
        >
            ...
            {/* Content Card */}
            <div className="relative w-full max-w-xl bg-white/95 dark:bg-dark-900/95 backdrop-blur-3xl border border-white dark:border-white/10 p-10 sm:p-20 rounded-[var(--radius-card)] shadow-[0_64px_200px_-32px_rgba(0,0,0,0.25)] dark:shadow-[0_64px_200px_-32px_rgba(0,0,0,0.8)] flex flex-col items-center text-center space-y-12 animate-in fade-in slide-in-from-bottom-16 duration-1000">

                {/* Visual Identity */}
                <div className="relative">
                    <div className="absolute inset-0 bg-primary/40 rounded-[var(--radius-card)] blur-3xl animate-pulse" />
                    <div className="relative w-28 h-28 bg-white dark:bg-dark-800 rounded-[var(--radius-card)] border border-gray-100 dark:border-white/10 flex items-center justify-center shadow-2xl">
                ...
                <div className="w-full space-y-8">
                    <button
                        ...
                        className="w-full py-7 bg-gray-900 dark:bg-white text-white dark:text-gray-950 text-2xl font-black rounded-[var(--radius-card)] shadow-2xl hover:scale-[1.02] active:scale-95 transition-all duration-300 group overflow-hidden relative"
                    >
